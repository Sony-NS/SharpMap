...
namespace DelftTools.Functions.Conversion
{
        ...
        where TTarget : IComparable where TSource : IComparable where TVariable : IComparable
    {
        ...
        public bool IsAutoSorted
        {
            get
            {
                if (variableToConvert == null)
                {
                    return true;//a wild guess :(
                }
                return variableToConvert.IsAutoSorted;
            }
        ...
        */
        ...
        public virtual object NoDataValue
        {
            ...
            {
                NoDataValues.Clear();
                NoDataValues.Add((TVariable)value);
            }
        }
        ...
        object IMeasurable.MinValidValue { get; set; }

        object IMeasurable.MaxValidValue { get; set; }
        ...
        public IMultiDimensionalArray CachedValues
        {
            get;
            set;
        }

        public bool AllowSetInterpolationType { get; set; }
        public bool AllowSetExtrapolationType { get; set; }

        public bool SkipUniqueValuesCheck
        {
            get { throw new NotImplementedException(); }
            set { throw new NotImplementedException(); }
        }
