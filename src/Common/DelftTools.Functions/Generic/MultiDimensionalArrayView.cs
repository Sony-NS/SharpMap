...
{
    [Serializable]
    public class MultiDimensionalArrayView<T> : MultiDimensionalArrayView, IMultiDimensionalArrayView<T>
    {
        ...
        public MultiDimensionalArrayView(IMultiDimensionalArray parent): base(parent)
        {
        }
