...
namespace DelftTools.Functions.Generic
{
    ...
    public class LazyMultiDimensionalArray<T> : Unique<long>, IMultiDimensionalArray<T>
    {
        ...
        {
            add { Source.PropertyChanging += value; }
            remove { Source.PropertyChanging -= value; }
        }
    }
}