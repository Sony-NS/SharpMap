...
namespace SharpMap.Data.Providers
{
    ...
    /// </code>
    /// </example>
    public class ShapeFile : IFileBasedFeatureProvider//, IWritableFeatureProvider<UInt32>
    {
        ...
        /// <remarks>
        /// This constructor creates a <see cref="ShapeFile"/>
        /// with an in-memory spatial index.
        /// </remarks>
        public ShapeFile(String filename, IGeometryFactory geoFactory)
        ...
        public static ShapeFile Create(String directory, String layerName,
                                               ...
                                               ICoordinateSystemFactory coordinateSystemFactory)
        {
             ...
             */
            return new ShapeFile(shapeFile, geoFactory, coordinateSystemFactory);
        }
        ...
        private class CoordinateValues
        {
            ...
            {
                X = ShapeFile.IsShapefileNullValue(x) ? ShapeFile.NullDoubleValue : x;
                Y = ShapeFile.IsShapefileNullValue(y) ? ShapeFile.NullDoubleValue : y;
                Z = ShapeFile.IsShapefileNullValue(z) ? ShapeFile.NullDoubleValue : z;
                M = ShapeFile.IsShapefileNullValue(m) ? ShapeFile.NullDoubleValue : m;
            }
        }
        ...
        private class StreamOffsetUtility
        {
            ...
            public CoordinateValues GetValues(StreamOffset offset, BinaryReader reader)
            {
                Double x,
                       y,
                       z = ShapeFile.NullDoubleValue,
                       m = ShapeFile.NullDoubleValue;
