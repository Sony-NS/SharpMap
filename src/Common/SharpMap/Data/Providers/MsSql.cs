...
namespace SharpMap.Data.Providers
{
	...
	/// </remarks>
	[Serializable]
    public class MsSql : Unique<long>, IFeatureProvider, IFileBased, IDisposable
	{
		...
		public IFeature GetFeature(int index)
		{
			using (SqlConnection conn = new SqlConnection(_ConnectionString))
			{
				string strSQL = "SELECT *, " + this.GeometryColumn + " AS sharpmap_tempgeometry FROM " + this.Table + " WHERE " + this.ObjectIdColumn + "='" + index.ToString() + "'";
