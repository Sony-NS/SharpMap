...
namespace SharpMap.Topology
{
    ...
    /// 
    /// TODO: rename it, it looks like moving logic.
    /// </summary>
    public interface IFallOffPolicy
    {
        FallOffPolicyRule FallOffPolicy { get; }
        /// <summary>
        /// Moves the coordinates of a geometry while applying a falloff policy. In some cases the falloffpolicy 
        ...
        /// to give the user a visual geefback. There is a 1 to 1 relation between the coordinates of geometry
