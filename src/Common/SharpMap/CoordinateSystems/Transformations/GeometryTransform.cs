...
{
	/// <summary>
	/// Helper class for transforming <see cref="GisSharpBlog.NetTopologySuite.Geometries.Geometry"/>
	/// </summary>
	public class GeometryTransform
	{
		...
		/// <summary>
		/// Transforms a <see cref="GisSharpBlog.NetTopologySuite.Geometries.Geometry"/>.
		/// </summary>
		...
		/// <summary>
		/// Transforms a <see cref="GisSharpBlog.NetTopologySuite.Geometries.LineString"/>.
		/// </summary>
