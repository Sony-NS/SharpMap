...
namespace SharpMap.Utilities.Indexing
{
    ...
    public struct RTreeIndexEntry
    {
        ...
        /// </summary>
        private SharpMap.Converters.Geometries.BoundingBox _box;
        public SharpMap.Converters.Geometries.BoundingBox Box
        {
            get { return _box; }
    ...
    {
        private SharpMap.Converters.Geometries.BoundingBox _box = SharpMap.Converters.Geometries.BoundingBox.Empty;
        private uint? _id;
        private RTree _tree;
