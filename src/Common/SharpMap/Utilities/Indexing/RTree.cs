...
namespace SharpMap.Utilities.Indexing
{
    ...
    public struct RTreeIndexEntry
    {
        ...
        /// </summary>
        private GisSharpBlog.NetTopologySuite.Geometries.Envelope _box;
        public GisSharpBlog.NetTopologySuite.Geometries.Envelope Box
        {
            get { return _box; }
    ...
    {
        private GisSharpBlog.NetTopologySuite.Geometries.Envelope _box = new GisSharpBlog.NetTopologySuite.Geometries.Envelope();
        private uint? _id;
        private RTree _tree;
        ...
        public GisSharpBlog.NetTopologySuite.Geometries.Envelope Join(GisSharpBlog.NetTopologySuite.Geometries.Envelope box1,
            GisSharpBlog.NetTopologySuite.Geometries.Envelope box2)
        {
            if (box2 == new GisSharpBlog.NetTopologySuite.Geometries.Envelope())
                return box1;
            else if (box1 == new GisSharpBlog.NetTopologySuite.Geometries.Envelope())
                return box2;
            else
                return new GisSharpBlog.NetTopologySuite.Geometries.Envelope(
                    Math.Min(box1.MinX, box2.MinX), Math.Min(box1.MinY, box2.MinY),
                    Math.Max(box1.MaxX, box2.MaxX), Math.Max(box1.MaxY, box2.MaxY));
        }
    }
    ...
    public class IndexNode : Node
    {
        ...
        public bool Remove(Node child)
        {
            ...
            if (removed && Borders(Box, child.Box))
            {
        ...
        {
            _children.Clear();
            Box = null; //GisSharpBlog.NetTopologySuite.Geometries.Envelope.Empty;
        }
    ...
    public abstract class RTree : IDisposable
    {
        ...
        public virtual List<UInt32> Search(GisSharpBlog.NetTopologySuite.Geometries.Envelope box)
        {
