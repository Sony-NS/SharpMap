...
namespace SharpMap.Rendering.Thematics
{
    public abstract class ThemeFactory
    {
        ...
        /// <param name="blend"><see cref="ColorBlend"/> defining the min and max colors</param>
            ...
            double minValue, double maxValue, int sizeMin, int sizeMax, bool skipColors, bool skipSizes, int numberOfClasses = 8)
        {
            ...
            {
                UpdateMinMaxForLineStrings(defaultStyle, sizeMin, sizeMax, minStyle, maxStyle, minColor, maxColor, minOutlineSize, maxOutlineSize);
            }
            else
            {
        ...
        private static void UpdateMinMaxForLineStrings(VectorStyle defaultStyle, int sizeMin, int sizeMax, VectorStyle minStyle, VectorStyle maxStyle, Color minColor, Color maxColor, float minOutlineSize, float maxOutlineSize)
        {
