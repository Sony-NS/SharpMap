...
namespace SharpMap.Rendering.Thematics
{
	...
	public class CustomTheme : ITheme
	{
		...
		public delegate SharpMap.Styles.IStyle GetStyleMethod(IFeature feature);
        ...
        public SharpMap.Styles.IStyle GetStyle<T>(T value) where T : IComparable<T>, IComparable
        {
