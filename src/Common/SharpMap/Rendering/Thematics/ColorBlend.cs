...
namespace SharpMap.Rendering.Thematics
{
	...
	public class ColorBlend: ICloneable
	{
		...
		public ColorBlend(System.Drawing.Color[] colors, float[] positions)
		{
			_Colors = colors;
		...
		public System.Drawing.Color GetColor(float pos)
		{
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof (ColorBlend)) return false;
	    ...
	    public override int GetHashCode()
	    {
	        unchecked
	        {
	            return ((_Colors != null ? _Colors.GetHashCode() : 0)*397) ^ (_Positions != null ? _Positions.GetHashCode() : 0);
	        }
	    }
	}
}
