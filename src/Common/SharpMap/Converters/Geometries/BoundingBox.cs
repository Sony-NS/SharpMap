...
namespace SharpMap.Converters.Geometries
{
	...
	public struct BoundingBox : IEquatable<BoundingBox>
	{
        ...
        */
		...
		public bool Intersects(GeometryFactory geometry)
		{
			//return this.Touches(geometry);
            //invalid for this method or throw new NotImplementedException();
            return false;
		}
		...
		public bool Touches(GeometryFactory geometry)
		{
        ...
        public bool Overlaps(GeometryFactory geometry)
        {
            if (geometry == null)
                return false;
		...
		public bool Contains(GeometryFactory geometry)
        {
            if (geometry == null)
                return false;
        ...
        public bool Within(GeometryFactory geometry)
        {
            if (geometry == null)
                return false;
        ...
        //public void ExpandToInclude(GeometryFactory geometry)
        //{
