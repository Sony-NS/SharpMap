...
namespace SharpMap.Converters.Geometries
{
    ...
    {
#if !DotSpatialProjections
        private GeoAPI.CoordinateSystems.ICoordinateSystem _SpatialReference;
#else
        ...
        /// <returns></returns>
        public static GeoAPI.Geometries.IGeometry GeomFromText(string WKT)
        {
        ...
        /// <returns></returns>
        public static GeoAPI.Geometries.IGeometry GeomFromWKB(byte[] WKB)
        {
