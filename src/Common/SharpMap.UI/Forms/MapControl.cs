...
namespace SharpMap.UI.Forms
{
    ...
    public class MapControl : Control, IMapControl
    {
        ...
        //NS, 2013-12-02
        private readonly DrawPolygonTool drawPolygonTool;
        ...
        /// <summary>
        /// NS, 2013-12-02, Fired when a new polygon has been defined
        /// </summary>
        ...
        public MapControl()
        {
            ...
            wheelPanZoomTool = new PanZoomUsingMouseWheelTool(this) { WheelZoomMagnitude = 0.8 };//-2};
        ...
        public DrawPolygonTool DrawPolygonTool
        {
            get { return drawPolygonTool; }
        }
