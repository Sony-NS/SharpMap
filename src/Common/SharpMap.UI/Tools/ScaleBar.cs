...
//Set the output format.
            ...
            for (i = 1; i <= NumTics; i++)
            {
                ...
                if (FormatNumber)
                {
                    string buf = value.ToFormattedString(0.000001);
                    //format the number
                ...
                else
                {
                    ...
                    graphics.DrawString(value.ToFormattedString(0.000001), font, brush, x + TicWidth * i, y, f);
                }
    ...
    public static class ScaleBarExtensions
    {
        public static string ToFormattedString(this double value, double epsilon)
        {
            string s;
