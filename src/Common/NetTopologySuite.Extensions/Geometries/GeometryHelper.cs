...
namespace NetTopologySuite.Extensions.Geometries
{
    ...
    {
        public static IGeometry GetRectangle(double x1, double y1, double x2, double y2)
        {
            return new Polygon(
                    new LinearRing(new[]
                                       {
                                           new Coordinate(x1, y1), new Coordinate(x1, y2), new Coordinate(x2, y2),
...
*/
        ...
        public static void SetCoordinate(IGeometry geometry, int coordinateIndex, ICoordinate coordinate)
        {
            ...
            geometry.EnvelopeInternal.SetCentre(geometry.Coordinates[coordinateIndex]); //wrong!?
        }
        ...
        public static void MoveCoordinate(IGeometry targetGeometry, IGeometry sourceGeometry, int coordinateIndex, double deltaX, double deltaY)
        {
            ...
            targetGeometry.EnvelopeInternal.SetCentre(targetGeometry.Coordinates[coordinateIndex]); //wrong!?
        }
        ...
        /// <summary>
        /// Splits the polygon at <para>splitPointX</para> and returns a left and right halft
        /// </summary>
        /// <param name="geometry"></param>
        /// <param name="calculateRightHalf"></param>
