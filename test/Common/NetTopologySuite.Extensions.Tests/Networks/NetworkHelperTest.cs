...
namespace NetTopologySuite.Extensions.Tests.Networks
{
    ...
    public class NetworkHelperTest
    {
        ...
        [Test]
        public void GetBranchFeatureOffsetFromGeometry()
        {
            var network = CreateTestNetwork();
            var branch1 = network.Branches[0];
            var offset = NetworkHelper.GetBranchFeatureOffsetFromGeometry(branch1,
        ...
        public void UpdateChainagesRegardlessOfOrderingAfterSplitBranch()
        {
            ...
            Assert.AreEqual(5, f1.Offset);
            Assert.AreEqual(30, f2.Offset);
            Assert.AreEqual(15, f3.Offset);
            Assert.AreEqual(10, f4.Offset);
        }
        ...
        public void SplitBranchUsesEditAction()
        {
            ...
            var action = (BranchSplitAction)network.CurrentEditAction;
            Assert.AreEqual(result.NewBranch,action.NewBranch);
            Assert.AreEqual(branch, action.SplittedBranch);
        }
        ...
        public void AddCrossSectionToBranch()
        {
            ...
            NetworkHelper.AddBranchFeatureToBranch(branchFeature, branch, branchFeature.Offset);
