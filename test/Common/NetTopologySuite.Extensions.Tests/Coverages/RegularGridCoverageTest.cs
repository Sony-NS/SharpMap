...
namespace NetTopologySuite.Extensions.Tests.Coverages
{
    ...
    public class RegularGridCoverageTest
    {
        ...
        public void ResizeIsFast()
        {
            ...
            TestHelper.AssertIsFasterThan(400, "Resized to 1000x1000", () => grid.Resize(1000, 1000, 1, 1));
        ...
        public void TimeDependentGrid2DPieceWiseConstantInterpolation()
        {
            ...
            grid2D.Time.InterpolationType = InterpolationType.Constant;
        ...
        public void TimeDependentGrid2DPieceWiseConstantExtrapolation()
        {
            ...
            grid2D.Time.InterpolationType = InterpolationType.None;
            grid2D.Time.ExtrapolationType = ExtrapolationType.Constant;
