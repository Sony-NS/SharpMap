...
namespace SharpMap.UI.Tests.Tools
{
    ...
    public class NewLineToolTest
    {
        ...
        IFeatureEditor SelectTool_FeatureEditorCreation(ILayer layer, IFeature feature, VectorStyle vectorStyle)
        {
            ...
            {
                return new LineStringFeatureEditor(new CoordinateConverter(mapControl), layer, feature, vectorStyle, network);
            }
            return null;
        }
...
*/
    ...
    {
        public LineStringFeatureEditor(ICoordinateConverter coordinateConverter, ILayer layer, IFeature feature, VectorStyle vectorStyle, IEditableObject editableObject)
