...
namespace DelftTools.Functions.Tests.Generic
{
    ...
    public class VariableTest
    {
        ...
        public void Clone()
        {
            var x = new Variable<int>("x") { Values = { 1, 2, 3 }, Unit = new Unit("distance","m")};
        ...
        public void PerformanceAddValuesToArgumentWithEventsIndependentVariable()
        {
            ...
            TestHelper.AssertIsFasterThan(175, () =>
            {
        ...
        public void PerformanceAddValuesRangeToArgumentWithEventsIndependentVariable()
        {
            ...
            TestHelper.AssertIsFasterThan(150, () => x.Values.AddRange(doubles));
        ...
        public class A : INotifyPropertyChange, IComparable
        {
            private string name;
